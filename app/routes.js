...
const routes = (
  <Route path="/" name="app" component={TopLevel}>
    ...
    <Route path="pysakit/:stopId" name="stop" component={StopPage} queries={StopQueries} renderLoading={() => <LoadingPage />}/>
    <Route path="pysakit/:stopId/kartta" name="stopMap" component={StopMapPage} queries={StopQueries} renderLoading={() => <LoadingPage />}/>
    <Route path="pysakit/:stopId/info" name="stopInfo" component={Error404} />
    <Route path="linjat" name="routeList" component={Error404} />
    <Route path="linjat/:routeId" name="route" component={RoutePage} queries={RouteQueries} renderLoading={() => <LoadingPage />}/>
    <Route path="lahdot/:tripId" name="trip" component={TripPage} queries={TripQueries} renderLoading={() => <LoadingPage />}/>
    <Route path="lahdot/:tripId/kartta" name="tripMap" component={TripMapPage} queries={TripQueries} renderLoading={() => <LoadingPage />}/>
