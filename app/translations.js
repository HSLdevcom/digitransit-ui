...
const translations = {
  ...
  en: {
    ...
    'navileg-mode-in-realtime': '{mode} on aikataulussa',
    'navileg-mode-in-schedule': 'The {mode} is on schedule',
    'navileg-rent-cycle': 'Pick up citybike',
    'navileg-rent-scooter': 'Pick up scooter',
    'navileg-scooter': 'Travel by scooter to',
    'navileg-start-in-realtime': 'Lähtee klo {time} {stop} {stopName}',
    'navileg-start-in-schedule': '{mode}n aikataulun muk. lähtö {time}',
  ...
  es: {
    ...
    'navileg-car': 'Aja',
    'navileg-mode-in-realtime': '{mode} on aikataulussa',
    'navileg-mode-in-schedule': 'Reaaliaikaista tietoa ei ole saatavilla',
    'navileg-rent-cycle': 'Nouda kapunkipyörä',
    'navileg-rent-scooter': 'Nouda sähköpotkulauta',
    'navileg-scooter': 'Potkulautaile',
    'navileg-start-in-realtime': 'Lähtee klo {time} {stopOrStation} {stopName}',
    'navileg-start-in-schedule': '{mode}n aikataulun muk. lähtö {time}',
    'navileg-walk': 'Kävele',
