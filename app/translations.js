...
const translations = {
  ...
  en: {
    ...
    'route-least-transfers': 'Least transfers',
    'route-least-walking': 'Least walking',
    'route-not-possible':
    ...
    'route-default': 'Oletusreitti',
    'route-destination-arrives': 'Saapuu / Päätepysäkki',
    'route-fastest': 'Nopein reitti',
    'route-from-here': 'Reititä täältä',
    'route-guide': 'Linjaohje',
    'route-here': 'Reititä tänne',
    'route-least-transfers': 'Vähiten vaihtoja',
    'route-least-walking': 'Vähiten kävelyä',
    'route-not-possible':
