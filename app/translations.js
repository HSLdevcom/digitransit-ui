...
const translations = {
  ...
  en: {
    ...
    'right-now': 'Right now',
    route: 'Route',
    'route-current-settings': 'Current settings',
  ...
  es: {
    ...
    'right-now': 'Juuri nyt',
    route: 'Linja',
    'route-current-settings': 'Nykyiset asetukset',
  ...
  fr: {
    ...
    route: 'Ligne',
    'route-customized-mode': 'Paramètres personnalisés',
  ...
  sv: {
    ...
    'right-now': 'Just nu',
    route: 'Linje',
    'route-current-settings': 'Nuvarande Inställningar',
