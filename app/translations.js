...
const translations = {
  ...
  sv: {
    ...
    'swipe-result-tab-left':
      'Navigeringsknapp för att kunna bläddra ruttförslag. Gå till föregående blad genom att trycka på enter eller mellanslag.',
    'swipe-result-tab-right':
      'Navigeringsknapp för att kunna bläddra ruttförslag. Gå till följande blad genom att trycka på enter eller mellanslag.',
    'swipe-result-tabs': 'Ruttförslag. Bläddra mellan blad med pilknapparna.',
    'terminal-page.description': 'Terminal {name}',
    'terminal-page.title': 'Terminal {name}',
    'terminal-page.title-short': 'Terminal',
