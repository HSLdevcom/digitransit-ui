...
const translations = {
  ...
  en: {
    ...
    'departure-is-canceled':
      '{departure}: departure at {time} has been canceled',
    'departure-time-in-minutes': '{minutes} min',
  ...
  es: {
    ...
    date: 'Päivämäärä',
    delete: 'Poista',
    'departure-is-canceled': '{departure}: lähtö kello {time} on peruttu',
    'departure-time-in-minutes': '{minutes} min',
    departures: 'Lähdöt',
  ...
  sv: {
    ...
    date: 'Datum',
    delete: 'Ta bort',
    'departure-is-canceled': '{departure}: avgång klockan {time} är inställd',
    'departure-time-in-minutes': '{minutes} min',
    departures: 'Avgångar',
