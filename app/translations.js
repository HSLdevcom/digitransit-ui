...
const translations = {
  ...
  de: {
    ...
    'canceled-legs': 'Annullierte Abfahrten auf der Strecke',
    car: 'Auto',
    ...
    'fetch-new-route': 'Holen eine neue Route',
    'footer-faq': 'FAQ',
    ...
    'swap-order-button-label': 'Umgekehrter Ursprung und Ziel',
    'terminal-page.description': 'Terminal - {name}',
    'terminal-page.title': 'Terminal',
    'terminal-page.title-short': 'Terminal - {name}',
