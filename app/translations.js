...
const translations = {
  ...
  'sv': {
    ...
    'stop-page.title': 'Hållplats {stop_name} - {stop_code}',
    'stop-page.description': 'Hållplats {stop_name} - {stop_code}',
    ...
    'minutes': 'min',
    'timetable': 'Tidtabell',
    'no-favourites': 'Genom att klicka på stjärnan kan du lägga till en linje eller hållplats till dina favoriter. ' +
      'Dina favoriter syns på den här sidan.',
    ...
    'login': 'Logga in',
    'off-canvas-info': `Genom att logga in kan du spara dina favoriter och använda dem
      med dina andra enheter.`,
    'cause': 'Orsak',
    ...
    'not-implemented-msg': `Om du vill delta i utvecklingsarbetet hittar du mer information
    ...
    'edit-favourites': 'Redigera platsen under fliken Dina favoriter',
    'specify-location': 'Ange din position',
