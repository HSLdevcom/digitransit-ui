...
const translations = {
  'en': {
    ...
    'stop-page.description': 'Stop - {name} {code}, {desc}',
    ...
    'trip-page.title': 'Route {shortName}',
    'trip-page.description': 'Route {shortName}, {longName}',
    ...
    'minutes': 'min',
    'timetable': 'Timetable',
    'no-favourites': 'Use the star buttons to add routes or stops to your favorites. ' +
    'Your favorites are shown on this page.',
    ...
    'citybike': 'City bike',
    'inquiry': 'How do you find the new Journey Planner? Please tell us!',
    ...
    'edit-favourites': 'Edit the location in the Favorites tab',
    ...
    'location-from-map': 'Location selected',
    ...
    'footer-link-to-privacy-policy': 'Description of the File',
    'agency': 'Operator',
  },
  'fi': {
    'frontpage': 'Etusivu',
