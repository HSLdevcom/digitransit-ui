...
const translations = {
  ...
  en: {
    ...
    'route-pattern-select.range.ke-ke': ' (Wednesdays)',
    'route-pattern-select.range.la-la': ' (Saturdays)',
    'route-pattern-select.range.la-su': ' (weekends)',
    'route-pattern-select.range.ma-la': ' (Mon-Sat)',
    'route-pattern-select.range.ma-ma': ' (Mondays)',
    'route-pattern-select.range.ma-pe': ' (weekdays)',
    'route-pattern-select.range.ma-su': ' ',
    'route-pattern-select.range.pe-la': ' (Fri-Sat)',
    'route-pattern-select.range.pe-pe': ' (Fridays)',
    'route-pattern-select.range.pe-su': ' (Fri-Sun)',
    'route-pattern-select.range.su-su': ' (Sundays)',
    'route-pattern-select.range.ti-ti': ' (Tuesdays)',
    'route-pattern-select.range.to-to': ' (Thursdays)',
  ...
  es: {
    ...
    'route-pattern-select.range.': ' ',
    'route-pattern-select.range.ke-ke': ' (keskiviikkoisin)',
    'route-pattern-select.range.la-la': ' (lauantaisin)',
    'route-pattern-select.range.la-su': ' (viikonloppuisin)',
    'route-pattern-select.range.ma-la': ' (ma-la)',
    'route-pattern-select.range.ma-ma': ' (maanantaisin)',
    'route-pattern-select.range.ma-pe': ' (arkisin)',
    'route-pattern-select.range.ma-su': ' ',
    'route-pattern-select.range.pe-la': ' (pe-la)',
    'route-pattern-select.range.pe-pe': ' (perjantaisin)',
    'route-pattern-select.range.pe-su': ' (pe-su)',
    'route-pattern-select.range.su-su': ' (sunnuntaisin)',
    'route-pattern-select.range.ti-ti': ' (tiistaisin)',
    'route-pattern-select.range.to-to': ' (torstaisin)',
    'route-pattern-select.range.undefined': ' ',
  ...
  sv: {
    ...
    'route-pattern-select.range.': ' ',
    'route-pattern-select.range.ke-ke': ' (onsdagar)',
    'route-pattern-select.range.la-la': ' (lördagar)',
    'route-pattern-select.range.la-su': ' (helger)',
    'route-pattern-select.range.ma-la': ' (mån-lör)',
    'route-pattern-select.range.ma-ma': ' (måndagar)',
    'route-pattern-select.range.ma-pe': ' (vardagar)',
    'route-pattern-select.range.ma-su': ' ',
    'route-pattern-select.range.pe-la': ' (fre-lör)',
    'route-pattern-select.range.pe-pe': ' (fredagar)',
    'route-pattern-select.range.pe-su': ' (fre-sön)',
    'route-pattern-select.range.su-su': ' (söndagar)',
    'route-pattern-select.range.ti-ti': ' (tisdagar)',
    'route-pattern-select.range.to-to': ' (torsdagar)',
    'route-pattern-select.range.undefined': ' ',
