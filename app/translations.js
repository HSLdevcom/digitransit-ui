...
const translations = {
  ...
  es: {
    ...
    'navileg-starts-in-realtime': 'Lähtee klo {time} {stop} {stopName}',
    'navileg-starts-in-schedule': '{mode}n aikataulun muk. lähtö {time}',
    'navileg-walk': 'Kävele',
  ...
  sv: {
    ...
    'navileg-mode-in-schedule': '{mode} on aikataulussa',
