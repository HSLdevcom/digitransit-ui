...
function getFonts() {
  return (
    <section>
      <p>
        Theme typeface Gotham doesn&apos;t have all symbols in one file, so both A and B variants
        must be specified. Also the weight must be specified every time the family is,
        and vice versa, because the weights of one font can be unsuitable for the other and
        therefore shouldn&apos;t be cross inherited when the parent element&apos;s font-family
        is not the same.
      </p>
      <p>
      ...
      <p style={{ fontWeight: '400' }}>
        Primary font: &quot;Gotham Rounded SSm A&quot;,&quot;Gotham Rounded SSm B&quot;,
        Arial, Georgia, Serif
      ...
      >
        Secondary font: &quot;Gotham XNarrow SSm A&quot;,&quot;Gotham XNarrow SSm B&quot;,
        Arial, Georgia, Serif
...
function StyleGuidelinesPage(props) {
