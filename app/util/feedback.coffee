...
recordResult = (piwik, time, a1, a2, a3) ->
  ...
  if a1 != undefined then piwik.setCustomVariable 1, 'nps', a1, 'visit'
  if a2 != undefined then piwik.setCustomVariable 2, 'prefer_new', a2, 'visit'
  if a3 then piwik.setCustomVariable 3, 'feedback', a3, 'visit'
  if a1 != undefined or a2 != undefined or a3
