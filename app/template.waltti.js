...
export default mergeWith({}, walttiConfig, {
  ...
  aboutThisService: {
      ...
      about: 'Tämä on __Theme__n kaupungin testi uudeksi reittioppaaksi __Theme__n alueella. Palvelu kattaa joukkoliikenteen, kävelyn, pyöräilyn ja yksityisautoilun rajatuilta osin. Palvelu perustuu Digitransit palvelualustaan.',
