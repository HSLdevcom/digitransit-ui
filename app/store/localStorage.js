...
export function setRoutingSettings(data) {
  ...
  const newSettings = {
    ...
    busWeight: data.busWeight
      ? data.busWeight
      : oldSettings.busWeight,
    railWeight: data.railWeight
      ? data.railWeight
      : oldSettings.railWeight,
    subwayWeight: data.subwayWeight
      ? data.subwayWeight
      : oldSettings.subwayWeight,
    tramWeight: data.tramWeight
      ? data.tramWeight
      : oldSettings.tramWeight,
    ferryWeight: data.ferryWeight
      ? data.ferryWeight
      : oldSettings.ferryWeight,
