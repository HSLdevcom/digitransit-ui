module.exports = {
  ...
  "constants": {
    ...
    "@landuse-hospital": "#F2E3E1",
    "@land": "#E8E0D8",
    "@name": "{name_en}",
    "@landcover": "#B0C89F",
    "@tunnel-case-dark": "#666",
    "@aeroway": "#dbcedb",
    "@label-city-md-size": {
      "base": 0.9,
      "stops": [
    ...
    "@road-street-limited": "#fff",
    "@landuse-glacier": "#EDE5DD",
    "@label-water": "#c8e5f9",
    "@poi-scalerank1": {
      "base": 1,
      "stops": [
