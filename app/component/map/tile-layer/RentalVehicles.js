...
class RentalVehicles {
        ...
        return res.arrayBuffer().then(
          buf => {
            ...
            if (
              ...
              // TODO this does not hold true for vehicles, as new ones may pop up here
              // (if area is serviced by any provider, which could, if OTP would support it,
              // be deduced from geofencing areas)
              ...
              // TODO: do we want to show single bikes when zoomed out? I'd think yes
  ...
  drawLargeIcon = (
    ...
    drawCitybikeIcon(
      ...
      1,
      iconName,
      false, // showAvailability don't show number of available vehicles, it's already on 
      isHilighted,
    );
  };
