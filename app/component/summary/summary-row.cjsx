...
class SummaryRow extends React.Component
  render: ->
    ...
    <div style={{paddingTop: "1em", fontSize: "10pt", color:"#999"}}>
      ...
      <div style={{position: "absolute", left: "calc(100% - 2.5em)", marginTop: "-0.5em" }}><Icon img={'icon-icon_arrow-right'} className="cursor-pointer"/></div>
      <br/>
    </div>
