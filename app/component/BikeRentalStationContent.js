      ...
      <div className="bike-station-page-container">
        ...
        />
          <div className="citybike-use-disclaimer">
            ...
            <div className="disclaimer-content"><FormattedMessage id="citybike-buy-season" /></div>
            <a
              onClick={e => {
                e.stopPropagation();
              }}
...
const BikeRentalStationContentWithBreakpoint = withBreakpoint(BikeRentalStationContent);

const containerComponent = createFragmentContainer(BikeRentalStationContentWithBreakpoint, {
...
export { containerComponent as default, BikeRentalStationContentWithBreakpoint as Component };