...
class Slider extends React.Component
  ...
  render: ->
    <div className={cx 'slider-container', @props.className}>
      ...
      <input id={@props.id} className={cx('slider')} type="range" defaultValue={@props.defaultValue} min={@props.min} max={@props.max} step={@props.step} onMouseUp={@props.onSliderChange} onTouchEnd={@props.onSliderChange} />
