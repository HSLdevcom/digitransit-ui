...
import { buildStaticMetaData } from '../../utils/server/metaUtils.js';
import { LightenDarkenColor } from '../../utils/shared/colorUtils.js';
import { boundWithMinimumAreaSimple } from '../../utils/shared/geo-utils.js';
...
function addMetaData(config) {
  ...
  // eslint-disable-next-line no-param-reassign
  config.metaData = buildStaticMetaData(config, manifestName);
...
export function getNamedConfiguration(configName) {
  if (!configs[configName]) {
    ...
    if (configName !== 'default') {
      ...
      additionalConfig = require(`./config.${configName}.js`).default;
    }
