  ...
  describe.only('When Origin is manually set to "Kamppi"', function () {
    ...
    it('should be possible to write Destination', function (browser) {
      browser.destination.enterText("Kluuvi", function () {
        browser.assert.value('#destination-autosuggest > div:nth-child(1) > input[type=text]', "Kluuvi, Helsinki");
      });
    });

    it('should use "Sampsantie 40, Helsinki" address when Destination is written as "sampsantie 40"', function (browser) {
      browser.destination.enterText("\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\b\sampsantie 40", function () {
        browser.assert.value('#destination-autosuggest > div:nth-child(1) > input[type=text]', "Sampsantie 40, Helsinki");
      });
    });
