...
describe('<PlatformNumber />', () => {
  ...
  it('should use plain class on outer span when plain is true', () => {
    ...
    expect(container.querySelector('.platform-number-plain')).not.toBe(null);
    expect(
  ...
  it('should show update icon and class when updated is true', () => {
    ...
    expect(container.querySelector('.platform-updated')).not.toBe(null);
    expect(container.querySelector('.platform-updated-icon')).not.toBe(null);
  });
